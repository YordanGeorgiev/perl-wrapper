package PerlWrapper::App::Utils::Logger ;
   ...
   use utf8 ; 
	...
	use File::Path;
	use Data::Printer ; 
	use PerlWrapper::App::Utils::Timer ; 
...
Perhaps a little code snippet.
    ...
    use PerlWrapper::Control::Utils::Logger ; 

    my $objLogger = PerlWrapper::Control::Utils::Logger->new( \$appConfig ) ;
    ...
...
=cut
	...
	sub Initialize {
		...
		$objTimer               = 'PerlWrapper::App::Utils::Timer'->new( $appConfig->{ 'TimeFormat' } );
