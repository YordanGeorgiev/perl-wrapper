# src/bash/perl-wrapper/funcs/create-relative-7z-package.spec.sh
...
doSpecCreateRelative7zPackage(){
	...
	cat doc/txt/perl-wrapper/specs/pckg/create-relative-7z-package.spec.txt
...
# eof file: src/bash/perl-wrapper/funcs/create-relative-7z-package.spec.sh
