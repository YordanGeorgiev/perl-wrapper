...
doTestCreateRelativePackage(){
   ...
   exit_code=0
	bash src/bash/perl-wrapper/perl-wrapper.sh -a create-relative-package
   export exit_code=$?
   ...
   bash src/bash/perl-wrapper/perl-wrapper.sh -a create-relative-package -i met/.tst.perl-wrapper
   export exit_code=$?
   ...
   test $exit_code -ne 0 && return
	...
	bash src/bash/perl-wrapper/perl-wrapper.sh -a create-relative-package -i met/.prd.perl-wrapper
   export exit_code=$?
   ...
   # test the call with the include file of the prd env
   bash src/bash/perl-wrapper/perl-wrapper.sh -a create-relative-package -i met/.git.perl-wrapper
   export exit_code=$?
