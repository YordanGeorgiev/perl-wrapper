# src/bash/perl-wrapper/funcs/create-full-7z-package.test.sh
...
doTestCreateFull7zPackage(){
	...
	cat doc/txt/perl-wrapper/tests/pckg/create-full-7z-package.test.txt
...
# eof file: src/bash/perl-wrapper/funcs/create-full-7z-package.test.sh
