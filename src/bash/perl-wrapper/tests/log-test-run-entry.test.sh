# src/bash/perl-wrapper/funcs/log-test-run-entry.test.sh
...
doTestLogTestRunEntry(){
	...
	cat doc/txt/perl-wrapper/tests/log-test-run-entry.test.txt
...
# eof file: src/bash/perl-wrapper/funcs/log-test-run-entry.test.sh
