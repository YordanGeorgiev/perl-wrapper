# src/bash/perl-wrapper/funcs/restore-tmux-session.help.sh
...
doHelpRestoreTmuxSession(){
	...
	cat doc/txt/perl-wrapper/helps/restore-tmux-session.help.txt
...
# eof file: src/bash/perl-wrapper/funcs/restore-tmux-session.help.sh
