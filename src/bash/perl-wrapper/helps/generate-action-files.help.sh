# src/bash/perl-wrapper/funcs/generate-action-files.help.sh
...
doHelpGenerateActionFiles(){
	...
	cat doc/txt/perl-wrapper/helps/generate-action-files.help.txt
...
# eof file: src/bash/perl-wrapper/funcs/generate-action-files.help.sh
