# src/bash/perl-wrapper/funcs/log-test-run-entry.func.sh
...
doLogTestRunEntry(){
   ...
   case "$1" in
     INIT)
         # cat doc/txt/perl-wrapper/funcs/log-test-run-entry.func.txt
...
# eof file: src/bash/perl-wrapper/funcs/log-test-run-entry.func.sh
