# src/bash/perl-wrapper/funcs/check-perl-syntax.func.sh
...
doCheckPerlSyntax(){
	...
	while read -r dir ; do 
		...
		cd $product_version_dir/src/perl/$dir ; 
...
# eof file: src/bash/perl-wrapper/funcs/check-perl-syntax.func.sh
